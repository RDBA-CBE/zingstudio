            ...
            <div className="section-content box-sort-in button-example mt-4 mb-5">
              <div className="pricingtable-row">
                <div className="row  m-auto gap-5 justify-content-center">
                  <div className="col-sm-12 col-md-12 col-lg-5 col-xl-3 p-lr0 align-items-stretch">
                    ...
                    style={{ background: "#e21100" }}>
                      ...
                      <li className="text-white px-4" style={{ borderTop: "none", color: "white" }}>JQUERY Banner Slider</li>
                        ...
                        <li className="text-white btn py-0 pt-2  mb-0" >
                  ...
                  <div className="col-sm-12 col-md-12 col-lg-5 col-xl-3 p-lr0 align-items-stretch">
                    <div className="project-content " style={{ background: "#1a43bfc7" }}>
                        <ul className="list-details">
                        <li className="text-white">
                            <span style={{ fontSize: "18px" }}>Web Design</span>
                            <span style={{ fontSize: "18px", fontWeight: "600" }}>Starting @ ₹ 10,000</span>
                        </li>
                        <li className="pt-3 pb-0 text-white" style={{ fontWeight: "600" }}>E-Commerce Websites</li>
                        <ul className="list-arrow mb-0 mt-0">
                      ...
                      <li className="text-white px-4" style={{ borderTop: "none", color: "white" }}>General Features With Modern Look</li>
                        ...
                        <li className="text-white btn py-0 pt-2 mb-0" >
                            <Link href={`/e-commerce-service`} className="site-button btnhover20 mt-3 " style={{ padding: "8px 15px", fontWeight: "600", fontSize: "15px", background:"#fff", color:"#000" , border:"none"}}>
                            View Service
                            </Link>
                        </li>
                        </ul>
                  ...
                  <div className="col-sm-12 col-md-12 col-lg-5 col-xl-3 p-lr0 align-items-stretch">
                    <div className="project-content " style={{ background: "#1a43bfc7" }}>
                      ...
                      <li className="text-white px-4" style={{ borderTop: "none", color: "white" }}>Keyphrase Optimization - 15 Pages</li>
                        ...
                        <li className="text-white btn py-0 pt-2 mb-0" >
                            <Link href={`/digital-marketing-service`} className="site-button btnhover20 mt-3 " style={{ padding: "8px 15px", fontWeight: "600", fontSize: "15px", background:"#fff", color:"#000" , border:"none"}}>
                            View Service
                            </Link>
                        </li>
                        </ul>
                  ...
                  <div className="project-content " style={{ background: "#e21100" }}>
                        ...
                        <li className="pt-3 pb-0 text-white" style={{ fontWeight: "600" }}>Premium</li>
                        <li className="text-white mt-0 pt-0" style={{ borderTop: "none" }}>
                            {/* <strong> */}
                            <ul className="list-arrow mb-0 mt-0">
                            <li className="text-white px-4">On-Page Optimization - Up to 15 Pages</li>
