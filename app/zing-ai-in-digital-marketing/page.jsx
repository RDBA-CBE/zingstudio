...
import NewZingAiDigitalTools from "@/components/newacademy/NewZingAiDigitalTools";
    ...
    <>
      <div className="page-wraper  " style={{background:"#fff"}}>
        <Header17 />
         ...
         <NewZingAiDigitalTools ToolsContent={ToolsContent} Tools1={Tools1} Tools2={Tools2} Tools3={Tools3}/>
