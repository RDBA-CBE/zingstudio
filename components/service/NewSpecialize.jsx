...
const NewSpecialize = () => {
  return (
    <section className="services-section text-white py-5 NewSpecialize">
      <div className="container">
        ...
        {services.map((service) => (
          ...
          <div className="service-content d-flex align-items-start">
            ...
            <div className="service-id text-secondary mx-3 mt-3 text-black">({service.id})</div>
            <div className="service-text">
              <h3 className="fw-bold display-5 service-title mb-2 text-black">{service.title}</h3>
              <p className="text-black mb-0">{service.description}</p>
            </div>
          </div>
        </div>
