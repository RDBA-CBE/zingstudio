...
import NewZingSocialMediaTools from "@/components/newacademy/NewZingSocialMediaTools";
    ...
    <>
      <div className="page-wraper  " style={{background:"#fff"}}>
        <Header17 />
         ...
         <NewZingSocialMediaTools ToolsContent={ToolsContent} Tools1={Tools1}  Tools3={Tools3}/>
