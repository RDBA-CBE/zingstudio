...
export default function page() {
    ...
    const serviceAbout ={
        ...
        title:"Zing SEO <br/> Supercharger",
    ...
    <>
      <div className="page-wraper  " style={{background:"#fff"}}>
        <Header17 />
         ...
         <BannerList course="Zing SEO Supercharger" services={services} />

         <NewCourseModules courselist={courselist} title="Zing SEO Supercharger"/>
