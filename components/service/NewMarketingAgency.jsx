...
export default function NewMarketingAgency() {
  return (
    <section
      className="content-inner-4 ev-aboutus  pt-5 bg-white"
      style={{
        backgroundImage: "",
    ...
    >
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-6 ev-about-content d-flex flex-column align-items-center justify-content-center mt-5 mt-lg-0">
            ...
            <p className=" mb-0" style={{color:"#282222"}}>
