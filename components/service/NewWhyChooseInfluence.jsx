            ...
            <div className="container-fluid py-5">
              <div className='row justify-content-center'>
                <div className='col-11'>
                  ...
                  <div className="col-12 col-lg-9 col-xl-6  text-white text-center text-lg-start mb-4 mb-lg-0" style={{zIndex:"100"}}>
                  
                    <h1 className="hero-title font-48 text-white" >
                    {title}
                    </h1>
                  ...
                  Get a quote
                    ...
                    {WhyChoose.map((reason, index) => (
                        <div key={index} className="mt-4">
                          <h4 className="fw-bold text-white">{reason.title}</h4>
