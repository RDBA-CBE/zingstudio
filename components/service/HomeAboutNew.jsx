...
export default function HomeAboutNew() {
  return (
    <div
      className="section-full content-inner const-about homeAbout"
      style={{
        backgroundImage: "url(/images/elementbg/about-us-bg-element.png)",
    ...
    >
      ...
      <div className="container-fluid">
        <div className="row align-items-center" style={{ padding: "0 5%" }}>
          ...
          >
            {" "}
            <img src="/images/home/i-specialize.png" />
          </div>
          ...
          >
            <div className="box1-home">
              ...
              >
                <img
                  src="/images/home/web-design.png"
                  width="150px"
                  alt="Website Design"
                />
              </div>
          ...
          >
            <div className="box2-home">
              ...
              >
                <img
                  src="/images/home/digital-marke.png"
                  width="150px"
                  alt="Website Design"
                />
              </div>
          ...
          >
            <div className="box3-home">
              ...
              >
                <img
                  src="/images/home/e-comerece.png"
                  width="150px"
                  alt="Website Design"
                />
              </div>
